...
<head>
    <title>Άρση αναστολής σύμβασης εργασίας | Υπουργείο Εργασίας & Κοινωνικών Υποθέσεων</title>
</head>
...
<div class="bgded" style="background:white;">
    <div id="breadcrumb" class="hoc clear">
        ...
        <ul>
            ...
            <li><span>&#47;</span> </li>
            <li>
                <p style="color: #363636;">Άρση αναστολης συμβασης εργασιας</p>
            </li>
        </ul>
    </div>
</div>
...
<div class="wrapper row3">
    <main class="hoc mycontainer clear">
        <form action="../../includes/employee-suspension.inc.php" method="post">
            <div class="edit-profile-container">
                ...
                if (!isset($_SESSION["username"])) {
                    ...
                    if ($_SESSION["usertype"] == 1 && empty($_SESSION["employeesForEmployer"]) !== true) {
                        ...
                        $_SESSION["removeSuspension"] = true;
