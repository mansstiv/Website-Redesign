    ...
    <footer id="footer" class="hoc clear">
        ...
        <div class="one_third">
            ...
            <ul class="nospace linklist">
                <li>
                    <article>
                        <h2 class="nospace font-x1"><a class="hyperlink" href="../ministry/services.php">Υπηρεσίες</a></h2>
                    </article>
                </li>
                <li>
                    <article>
                ...
                <li>
                    <article>
                        <h2 class="nospace font-x1"><a class="hyperlink" href="../ministry/accessibility.php">Προσβασιμότητα</a></h2>
                    </article>
                </li>
            </ul>
        </div>
