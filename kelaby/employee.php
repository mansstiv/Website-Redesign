...
<div class="wrapper row3">
  <main class="hoc mycontainer clear">
    <ul class="list-covid-info ">
      <li>
        <p style="font-size: 15px;">Ενημερώσου για <a class="hyperlink" href="covid.php">τα τελευταία μέτρα</a> σχετικά με την πανδημία και τον χώρο της εργασίας.</p>
      </li>
    </ul>

    <ul class="nospace group services mylist">
      <li class="one_third first list-layout">
        <h6 class="heading clear-text-transform top-margin-13"><a class="font-size-heading" href="employee-covid.php">
